...
class RecordingRequestPanelTests(unittest.TestCase):
    ...
    def test_testimony_review_tracks_source_speaker_identification(self):
        ...
        self.assertIn(b'<div class="bulk-toolbar" data-bulk-toolbar>', review.data)
        self.assertIn(b'<div class="bulk-selection" data-bulk-selection hidden>', review.data)
        self.assertNotIn(b'<div class="bulk-toolbar" data-bulk-toolbar hidden>', review.data)
